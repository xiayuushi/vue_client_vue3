<template>
    ...
    <nav>
      ...
      <a :class="{ active: componentName === 'GoodsComment' }" href="javascript:;" @click="componentName='GoodsComment'">商品评价<span>({{ goods.commentCount }})</span></a>
    </nav>
    <!-- 切换内容的地方 -->
